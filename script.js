...
// toString() | Returns a string as a string | can be used to convert a string object into a string. ** Every JavaScript object has a toString() method. Normally, you **will not use it in your own code.
